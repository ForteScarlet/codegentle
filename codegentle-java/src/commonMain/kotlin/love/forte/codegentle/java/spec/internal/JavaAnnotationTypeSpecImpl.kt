...
/**
 * Implementation of [JavaAnnotationTypeSpec.Builder].
 */
internal class JavaAnnotationTypeSpecBuilderImpl(
    override val name: String
) : JavaTypeSpecBuilderImpl<JavaAnnotationTypeSpec, JavaAnnotationTypeSpec.Builder>(),
    JavaAnnotationTypeSpec.Builder {
    ...
    override fun build(): JavaAnnotationTypeSpec {
        ...
        return JavaAnnotationTypeSpecImpl(
            name = name,
            kind = JavaTypeSpec.Kind.ANNOTATION,
