...
/**
 * Internal builder implementation for [JavaSimpleTypeSpec].
 */
internal class JavaSimpleTypeSpecBuilderImpl(
    override val kind: JavaTypeSpec.Kind,
    override val name: String
) : JavaTypeSpecBuilderImpl<JavaSimpleTypeSpec, JavaSimpleTypeSpec.Builder>(),
    JavaSimpleTypeSpec.Builder {
    init {
    ...
    override fun superclass(superclass: TypeName): JavaSimpleTypeSpec.Builder = apply {
    ...
    override fun addSuperinterfaces(superinterfaces: Iterable<TypeName>): JavaSimpleTypeSpec.Builder = apply {
        checkSuperinterfaceSupport()
        this.superinterfaces.addAll(superinterfaces)
    }

    override fun addSuperinterface(superinterface: TypeName): JavaSimpleTypeSpec.Builder = apply {
        checkSuperinterfaceSupport()
