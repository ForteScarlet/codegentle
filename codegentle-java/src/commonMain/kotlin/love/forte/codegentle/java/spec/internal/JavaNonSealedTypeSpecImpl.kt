...
/**
 * Internal builder implementation for [JavaNonSealedTypeSpec].
 */
internal class JavaNonSealedTypeSpecBuilderImpl(
    override val kind: JavaTypeSpec.Kind,
    override val name: String
) : JavaTypeSpecBuilderImpl<JavaNonSealedTypeSpec, JavaNonSealedTypeSpec.Builder>(),
    JavaNonSealedTypeSpec.Builder {
    init {
    ...
    override fun superclass(superclass: TypeName): JavaNonSealedTypeSpec.Builder = apply {
    ...
    override fun addSuperinterfaces(superinterfaces: Iterable<TypeName>): JavaNonSealedTypeSpec.Builder = apply {
        checkSuperinterfaceSupport()
        this.superinterfaces.addAll(superinterfaces)
    }

    override fun addSuperinterface(superinterface: TypeName): JavaNonSealedTypeSpec.Builder = apply {
        checkSuperinterfaceSupport()
        this.superinterfaces.add(superinterface)
    }

    private fun checkSuperinterfaceSupport() {
        check(kind.states.superinterfacesSupport) {
            "`superinterface` is not supported for kind $kind"
        }
    }
